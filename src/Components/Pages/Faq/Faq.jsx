...
const Offer = [
...

  {
    ...
    text1:
      "Bukan hanya sekadar musik. Kalian juga akan menemukan makanan dan juga aktifitas menarik di dalam area festival.",
  },

  {
    ...
    text1:
      "Tentu saja, silahkan bawa jas hujanmu, akan tetapi payung tidak diperbolehkan untuk dibawa ke area festival.",
  },

  {
    price:
      "WHAT ARE CONSIDERED PROFESSIONAL CAMERAS AND PROFESSIONAL DIGITAL CAMERAS? IS IT ALLOWED?",
    ...
    text1:
      "Kamera apapun diperbolehkan. Silahkan mengambil foto sebanyak-banyaknya.",
  },
...

  {
    ...
    text1:
      "Kenakan saja pakaian yang nyaman menurut anda. Namun sangat disarankan mengenakan sepatu yang nyaman dan tidak merepotkan kamu (sneakers, sepatu keds). Pastikan anda tidak mengenakan sesuatu yang bertentangan dengan aturan kami.",
  },

  {
    ...
    text1:
      "Dilarang membawa makanan dan minuman dari luar. Ismaya Group akan menyediakan konsep resto F&B yang akan menyediakan makanan dan minuman buat kalian selama festival berlangsung. Pastikan anda membawa uang yang cukup.",
  },
  ...
  {
    price:
      "WILL THERE BE MEDIC ON THE FESTIVAL AREA? IF YES, WHERE CAN I LOCATE IT?",
    ...
    text1:
      "Ya, tentu saja! Tenaga medis akan tersedia pada saat acara berlangsung, kita mempunyai beberapa titik area medik pada saat acara berlangsung.",
  },
...

  {
    ...
    text1:
      "Keduanya dapat digunakan untuk memasuki festival. Namun, apabila anda mempunyai tiket VIP, anda dapat menikmati special treatment di VIP area, seperti toilet dan bar sendiri, bahkan anda juga akan mendapatkan VIP viewing area di depan stage. Pintu masuk GA dan VIP akan dipisah.",
  },

  {
    ...
    text1:
      "Siapapun yang membeli tiket jenis EARLY ENTRY harus masuk ke area festival SEBELUM pukul 18:00 atau diharuskan melakukan top up sesuai dengan harga yang berlaku saat itu.",
  },
];
